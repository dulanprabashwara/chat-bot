            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
              {!user ? (
                ...
                <button
                  ...
                  className="group inline-flex items-center gap-3 text-lg font-semibold px-16 py-4 rounded-xl border border-green-600 dark:border-green-400 text-green-600 dark:text-green-400 bg-background hover:border-green-500 dark:hover:border-green-300 hover:text-green-500 dark:hover:text-green-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500/60 dark:focus-visible:ring-green-400/60 transition-colors"
                  aria-label="Explore available bot characters"
                >
                  <span>Explore Bots</span>
          </section>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-5">
              {[
                ...
                },
                {
                  ...
                  blurb: "Learning & explanations.",
                },
                {
                  name: "Friend",
                  img: "/images/friend-bot.png",
                  blurb: "Casual conversation & support.",
                },
                {
                  name: "Expert",
                  img: "/images/expert-bot.png",
                  blurb: "Specialized knowledge & advice.",
                },
                {
                  name: "Artist",
                  img: "/images/artist-bot.png",
                  blurb: "Creative projects & inspiration.",
                },
              ].map((bot) => (
                <button
                  key={bot.name}
                  ...
                  className="bg-muted border border-border rounded-lg p-4 flex flex-col items-center text-center hover:border-green-500 dark:hover:border-green-400 transition-colors"
                >
                  <img
                    src={bot.img}
                    alt={bot.name}
                  ...
                  <p className="text-sm text-muted-foreground">{bot.blurb}</p>
                </button>
              ))}
            </div>
          </section>
              ...
              {[
                {
                  ...
                  description: "Get immediate answers and conversations.",
                },
                {
                  icon: "🎭",
                  title: "Personality Types",
                  description: "Choose from different AI personalities.",
                },
                {
                  icon: "💾",
                  title: "Memory Persistence",
                  description: "Your conversations are remembered.",
                },
                {
                  icon: "🔒",
                ...
                },
                {
                  ...
                  description: "24/7 access to your AI companions.",
                },
                {
                  icon: "⚡",
                  title: "Fast & Reliable",
                ...
                <div
                  key={feature.title}
                  className="bg-muted border border-border rounded-lg p-6 flex flex-col gap-4 hover:border-green-500 dark:hover:border-green-400 transition-colors"
                >
              ...
              {[
                {
                  ...
                  text: "Pick from pre-built personalities or create custom ones.",
                },
                {
                  step: "2",
                  title: "Start Chatting",
                  text: "Begin conversations instantly with your AI companion.",
                },
                {
                  step: "3",
                  title: "Build History",
                ...
                <li
                  key={s.step}
                  className="relative bg-muted border border-border rounded-lg p-6 flex flex-col gap-3 hover:border-green-500 dark:hover:border-green-400 transition-colors"
                >
